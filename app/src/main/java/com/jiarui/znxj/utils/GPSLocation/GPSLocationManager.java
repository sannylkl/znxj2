package com.jiarui.znxj.utils.GPSLocation;
...
public class GPSLocationManager {
     ...
     */
    public void start(GPSLocationListener gpsLocationListener,boolean isTiming) {
        this.start(gpsLocationListener, isOPenGps, isTiming);
    }
     ...
     */
    public void start(GPSLocationListener gpsLocationListener, boolean isOpenGps,boolean isTiming) {
        ...
        Log.e("isOPenisGpsEnabled",""+isGpsEnabled+"\tisOPenGps:"+isOPenGps);

        if (!isGpsEnabled && !isOPenGps) {
            openGPS();
            return;
        }
        Log.e("isOPenFINE_LOCATION",""+ActivityCompat.checkSelfPermission(mContext.get(), Manifest.permission.ACCESS_FINE_LOCATION)+"\tGRANTED:"+ PackageManager.PERMISSION_GRANTED);
        Log.e("isOPenCOARSE_LOCATION",""+ActivityCompat.checkSelfPermission(mContext.get(), Manifest.permission.ACCESS_COARSE_LOCATION)+"\tGRANTED:"+ PackageManager.PERMISSION_GRANTED);
