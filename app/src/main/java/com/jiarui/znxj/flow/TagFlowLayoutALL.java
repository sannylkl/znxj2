 ...
 */
public class TagFlowLayoutALL extends FlowLayout implements TagAdapter.OnDataChangedListener {
    private TagAdapter mTagAdapter;
    private boolean mAutoSelectEffect = true;
    private int mSelectedMax = -1;//1为限制一个选中项目-1为不限制数量
    ...
    public TagFlowLayoutALL(Context context, AttributeSet attrs, int defStyle) {
    ...
    public TagFlowLayoutALL(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TagFlowLayoutALL(Context context) {
        this(context, null);
    }
