...
import static com.jiarui.znxj.R.id.tv_group_name_rigth;

/**
 * Created by Jay on 2015/9/25 0025.
 */
public class MyBaseExpandableListAdapter2 extends BaseExpandableListAdapter {

    private ArrayList<Group> gData;
    private ArrayList<ArrayList<Item>> iData;
    private Context mContext;

    public MyBaseExpandableListAdapter2(ArrayList<Group> gData, ArrayList<ArrayList<Item>> iData, Context mContext) {
        this.gData = gData;
        this.iData = iData;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_task_group, parent, false);
            groupHolder = new ViewHolderGroup();
            groupHolder.tv_group_name = (TextView) convertView.findViewById(R.id.tv_group_name);
            groupHolder.tv_group_name_rigth = (TextView) convertView.findViewById(tv_group_name_rigth);
...
//        if (groupPosition == gData.size()-1) {
//            groupHolder.te.setVisibility(View.GONE);
//        }
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_task_item, parent, false);
        ...
        if (iData.get(groupPosition).get(childPosition).getrNameitme().equals("正常")) {
            itemHolder.tv_group_name_itme_rigth.setTextColor(Color.parseColor("#92C35C"));
        } else if (iData.get(groupPosition).get(childPosition).getrNameitme().equals("异常")) {
            itemHolder.tv_group_name_itme_rigth.setTextColor(Color.parseColor("#F46666"));
        }
        return convertView;
    }
